...
namespace Glare\Vendor\Spatie\MediaLibrary\MediaCollections\Commands;
...
class CleanCommand extends Command
{
    ...
    protected function deleteConversionFilesForDeprecatedConversions(Media $media): void
    {
        ...
        $conversionWebpFilePaths = $conversionFilePaths->map(function ($item) {
            $fileName = pathinfo($item, PATHINFO_FILENAME);
            return $fileName . '.webp';
        });
        $conversionFilePaths = $conversionFilePaths->merge($conversionWebpFilePaths);
