<div class="block-contact is-full {!! $class ?? 'in-footer' !!}">
    ...
    <div class="company">
        ...
        <div class="bank">
            @if(!empty($settings->bank_name))<span>{!! $settings->bank_name !!}:</span>@endif @if(!empty($settings->bank_account))<span>{!! $settings->bank_account !!}</span>@endif
        </div>
        @endif
