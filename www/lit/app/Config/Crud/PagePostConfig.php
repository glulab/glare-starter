...
class PagePostConfig extends CrudConfig
{
    ...
    public function index(CrudIndex $page)
    {
        ...
        $page->table(function ($table) {
            ...
            $table->col('KATEGORIA')->value(\Facades\Lit\Support\LitPageHelper::badgeLight('{categories.#.title}'))/*->sortBy('categories_count')*/->center()->small();
            $table->col('GRUPA')->value(\Facades\Lit\Support\LitPageHelper::badgeLight('{groups.#.name}'))/*->sortBy('groups_count')*/->center(); // $table->col('GRUPY')->value('{groups_count}')->sortBy('groups_count')->center();
